    ...
    const linkSections = [
        {
            ...
            links: [
                { text: t('footer_earphones'), path: '/', icon: null },
                { text: t('footer_headphones'), path: '/', icon: null },
                { text: t('footer_smartphones'), path: '/', icon: null },
                { text: t('footer_laptops'), path: '/', icon: null },
            ]
        },
        {
            title: t('footer_website'),
            links: [
                { text: t('footer_home'), path: '/', icon: null },
                { text: t('footer_privacy'), path: '/', icon: null },
                { text: t('footer_plus_member'), path: '/pricing', icon: null },
                { text: t('footer_create_store'), path: '/create-store', icon: null },
            ]
        },
        {
            title: t('footer_contact'),
            links: [
                { text: settings.email, path: `mailto:${settings.email}`, icon: MailIcon },
                { text: settings.phone, path: `tel:${settings.phone}`, icon: PhoneIcon },
                { text: settings.address, path: '/contact', icon: MapPinIcon }
            ]
        }
    ];

    const socialIcons = [
        settings.facebook && { icon: FacebookIcon, link: settings.facebook },
        settings.instagram && { icon: InstagramIcon, link: settings.instagram },
        settings.twitter && { icon: TwitterIcon, link: settings.twitter },
        settings.linkedin && { icon: LinkedinIcon, link: settings.linkedin },
    ].filter(Boolean)
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">{t('footer_about')}</p>
